                                        ...
                                        <div class="row d_flex">
                                            <div class="col-md-5">
                                                <div class="board">
                                                    ...
                                                    <div class="link_btn">
                                                        <a class="btn btn-primary" href="/user/datadiri">Reservasi
                                                            Disini</a>
                                                    </div>
                                                    {{-- @auth
                                                        <div class="link_btn">
                    ...
                    <div class="row d_flex">
                        ...
                        <div class="col-md-6">
                            <div class="about_img text_align_center pr-3 pb-5">
                                <figure><img src="{{ asset('Landing-page/images/about.webp') }}" alt="foto1" />
                                </figure>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-4 ">
                                <div class="infoma" id="kontak">
                                    ...
                                    <ul class="conta">
                                        ...
                                        <li> <i class="fa fa-envelope" aria-hidden="true"></i>tamanpinusbatu@gmail.com
                                        </li>
                                    </ul>
                                </div>
                                <div class="infoma">
