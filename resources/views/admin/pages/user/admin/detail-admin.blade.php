@foreach ($datas as $data)
    <div class="modal fade" id="modalDetail{{ $data->admin_code }}" tabindex="-1"
        aria-labelledby="modalLabel{{ $data->id }}" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <!-- HEADER -->
                <div class="modal-header">
                    <h5 class="modal-title" id="modalLabel{{ $data->admin_code }}">Detail Admin</h5>
                    ...
                    <div class="row g-4">
                        <div class="col-lg-8">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li class="d-flex align-items-center gap-1 mb-12">
                                    <span class="w-30 text-md fw-semibold text-primary-light"> Job</span>
                                    <span class="w-70 text-secondary-light fw-medium">: {{ $data->job }}</span>
                                </li>
                                <li class="d-flex align-items-center gap-1 mb-12">
