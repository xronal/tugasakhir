                ...
                <div class="row">
                    <div class="col-12 mb-20">
                        ...
                        <input type="text" class="form-control radius-8" placeholder="Enter Package Code "
                            name="transaction_code" value="{{ $datas->transaction_code }}">
                    </div>
                    <div class="col-md-6 mb-20">
                        ...
                        <div class=" position-relative">
                            <input class="form-control radius-8 bg-base" id="transaction_date" type="text"
                                ...
                                value="{{ \Carbon\Carbon::parse($datas->transaction_date)->format('d/m/Y H:i') }}">
                            <span
                    ...
                    <div class="col-md-6 mb-20">
                        ...
                        <div class=" position-relative">
                            <input class="form-control radius-8 bg-base" id="payment_date" type="text"
                                ...
                                value="{{ \Carbon\Carbon::parse($datas->payment_date)->format('d/m/Y H:i') }}">
                            <span
                                class="position-absolute end-0 top-50 translate-middle-y me-12 line-height-1"><iconify-icon
                                    icon="solar:calendar-linear" class="icon text-lg"></iconify-icon></span>
                        </div>
                    ...
                    <div class="col-12 mb-20">
                        ...
                        <select class="form-select" aria-label="Default select example" name="payment_status">
                            <option disabled {{ !$datas->payment_status ? 'selected' : '' }}>Pilih Status Pembayaran
                            </option>
                            <option value="paid" {{ $datas->payment_status == 'paid' ? 'selected' : '' }}>Paid</option>
                            <option value="unpaid" {{ $datas->payment_status == 'unpaid' ? 'selected' : '' }}>Unpaid
                            </option>
                        </select>
                    </div>
                        ...
                        <select class="form-select" aria-label="Default select example" name="customer_code">
                            ...
                            @foreach ($customers as $cust)
                                <option value="{{ $cust->customer_code }}"
                                    {{ $datas->customer_code == $cust->customer_code ? 'selected' : '' }}>
                                    {{ $cust->customer_name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6 mb-20">
                        ...
                        <div class=" position-relative">
                            <input class="form-control radius-8 bg-base" id="startDate" type="text"
                                ...
                                value="{{ \Carbon\Carbon::parse($datas->checkin_date)->format('d/m/Y H:i') }}">
                            <span
                                class="position-absolute end-0 top-50 translate-middle-y me-12 line-height-1"><iconify-icon
                                    icon="solar:calendar-linear" class="icon text-lg"></iconify-icon></span>
                        </div>
                    ...
                    <div class="col-md-6 mb-20">
                        ...
                        <div class=" position-relative">
                            <input class="form-control radius-8 bg-base" id="endDate" type="text"
                                ...
                                value="{{ \Carbon\Carbon::parse($datas->checkout_date)->format('d/m/Y H:i') }}">
                            <span
                                class="position-absolute end-0 top-50 translate-middle-y me-12 line-height-1"><iconify-icon
                                    icon="solar:calendar-linear" class="icon text-lg"></iconify-icon></span>
                        </div>
                    </div>
                    @foreach ($packagetrans as $packagetransaction)
                        <div class="col-md-6 mb-20">
                            <label for="package"
                                class="form-label fw-semibold text-primary-light text-sm mb-8">Package</label>
                            <div class=" position-relative">
                                <select class="form-select package" aria-label="Default select example" name="package_code"
                                    id="package">
                                    <option selected>Open this select menu</option>
                                    @foreach ($packages as $data)
                                        <option value="{{ $data->package_code }}"
                                            {{ $packagetransaction->package_code == $data->package_code ? 'selected' : '' }}>
                                            {{ $data->package_name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6 mb-20">
                            <label for="package_price"
                                class="form-label fw-semibold text-primary-light text-sm mb-8">Package
                                Price</label>
                            <div class=" position-relative">
                    ...
                    <select class="d-none" id="personentry-template">
                        ...
                        @foreach ($personentry as $data)
                            <option value="{{ $data->person_entry_code }}" data-price="{{ $data->price }}"
                                {{ $datas->person_entry_code == $data->person_entry_code ? 'selected' : '' }}>
                                {{ $data->person_type }}
                            </option>
                        @endforeach
                    </select>
